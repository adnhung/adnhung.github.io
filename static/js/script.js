   ...
   /*------------------------------------------
    ...
    if($('.service-carousel-et-one').length){
        $('.service-carousel-et-one').owlCarousel({
            ...
            smartSpeed: 700,
            navText: [
              '<img src="./static/images/icon/arro-left.png">',
              '<img src="./static/images/icon/arro-right.png">'
            ],
            responsive: {
                0: {
                    items: 1,
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2021/05/29', function(event) {
    ...
    if ($("#video-background").length) {
        $('#video-background').YTPlayer({
			...
			var settings = {
                ...
                $('.awp-playlist-item a[data-id="0"] span').text('01. Hơn Cả Yêu');
                $('.awp-playlist-item a[data-id="1"] span').text('02. Ánh Nắng Của Anh');
                $('.awp-playlist-item a[data-id="2"] span').text('03. Mình Cưới Nhau Đi');
                $('.awp-playlist-item a[data-id="3"] span').text('04. Có Chắc Yêu Là Đây');
